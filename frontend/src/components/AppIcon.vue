...
// Minimal inline icon set (stroke-based, Feather-style) so the app doesn't need an
// icon font or extra dependency. `paths` is a static, internal lookup — the v-html
// below only ever renders these fixed strings, never user input.
const paths = {
